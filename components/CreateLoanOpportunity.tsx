...
export default function CreateLoanOpportunity() {
  ...
  return (
    <div style={{display:'grid', gap:'15px'}}>
      ...
      <button type='button' onClick={handlePostJobEvent} className='text-white bg-blue-500 py-2 focus:outline-none hover:bg-pink-600 rounded text-lg' style={{justifySelf:'center', width:'80%'}}>Post Opportunity</button>
    </div>
  )
}
