									...
									<div className="grid grid-cols-4 gap-6">
										<div className="col-span-6">
											<h1 className="text-2xl font-bold leading-7 text-stone-600">
												Set your stable coin allocation, and provide you token and incentive for the period
											</h1>
										</div>
										...
										<div className="col-span-6 sm:col-span-4">
											<label htmlFor="erc-20-address" className="block text-sm font-medium text-stone-600">
												ERC20 Token adress
											</label>
											<input
												type="text"
										...
										<div className="col-span-6 sm:col-span-4">
											<label htmlFor="erc-20-price" className="block text-sm font-medium text-stone-600">
										...
										<div className="col-span-6 sm:col-span-4">
											<label htmlFor="loan-incentive" className="block text-sm font-medium text-stone-600">
