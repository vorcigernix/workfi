  ...
  return (
    <>
      ...
      <div className="my-5  grid rounded-lg bg-white py-5 px-20 shadow-lg">
        ...
        <div className="text-gray-500" style={{ marginBottom: '2rem' }}>
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between">
        ...
        <span className="rounded-full bg-blue-500 py-1 px-7 text-center text-white">
          {getStatus(bounty.status)}
        </span>
      </div>
      <div className="flex">
        <span className="w-1/2 text-left text-blue-500">
          Sponsor oppurtunity: $1800
        </span>
        <span className="w-1/2 text-left text-blue-500">APR: 40%</span>
      </div>
    </div>
  )
}
